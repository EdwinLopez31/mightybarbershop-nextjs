        ...
        <div className="flex items-center justify-end overflow-hidden md:justify-center">
          ...
          >
            <div className="absolute inset-y-0 left-0 ">
              <Logo className="w-12 h-12 mt-2 left-14 top-1/2" />
            </div>
          </Link>
          <div className="hidden text-white gap-x-5 md:flex ">
            <Link
              to="header"
              activeClass="border-yellow-400"
              className="px-4 py-3 transition duration-300 border-b-2 border-transparent cursor-pointer hover:border-yellow-400 md:px-5"
              smooth={true}
              spy={true}
              duration={500}
              offset={-360}
